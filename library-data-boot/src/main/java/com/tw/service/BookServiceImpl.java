...
public class BookServiceImpl implements BookService {
    ...
    public Book findByIsbn(int isbn) {
        return repo.findById(isbn).orElseThrow(() -> new InvalidBookException("Book with ISBN " + isbn + " not found"));
    }
    ...
    public Book findByTitle(String title) {
        return repo.findByTitle(title).orElseThrow(() -> new InvalidBookException("Book with title " + title + " not found"));
    }
